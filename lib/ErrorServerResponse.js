 ...
 */var ErrorServerResponse=/*#__PURE__*/function(_Error){(0,_inherits2["default"])(ErrorServerResponse,_Error);/**
   ...
   */function ErrorServerResponse(statusCode,statusText){var _this;var message=arguments.length>2&&arguments[2]!==undefined?arguments[2]:null;(0,_classCallCheck2["default"])(this,ErrorServerResponse);_this=(0,_possibleConstructorReturn2["default"])(this,(0,_getPrototypeOf2["default"])(ErrorServerResponse).call(this,message));_this.name="Server Response";_this.statusCode=statusCode;_this.statusText=statusText;_this.message=message;if(Error.captureStackTrace){Error.captureStackTrace((0,_assertThisInitialized2["default"])(_this),ErrorServerResponse)}else{_this.stack=new Error().stack}return _this}return ErrorServerResponse}((0,_wrapNativeSuper2["default"])(Error));exports["default"]=ErrorServerResponse;
